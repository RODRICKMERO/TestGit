...
{
$page_name="viewresultdean.php"; //  If you use this code with a different page ( or file ) name then change this 
$start=$_GET['start'];
...
echo" </font></center>";
echo"<center><font face='verdana' color='red'> SELECT YEAR AND SEMESTER  or <a href='progressive.php?'> VIEW PROGRESS </a></center><br> </font>";
}
...
{
echo"<tr><td rowspan='2'> YEAR $I </td><td><a href='resultdean.php?semester=i$I'> SEMESTER I </a></td>";

echo"<td rowspan='2'><a href='resultdean.php?course_year=$I'> OVARALL YEAR $I </a></td></tr><tr><td><a href='resultdean.php?semester=ii$I'> SEMESTER II </a></td></tr> ";}else
{
echo"<tr><td rowspan='2'> YEAR $I </td><td><a href='resultdean.php?semester=i$I'> SEMESTER I </a></td>";
if($SEME=="II")
{
echo"<td rowspan='2'><a href='resultdean.php?course_year=$I'> OVARALL YEAR $I </a></td></tr><tr><td><a href='resultdean.php?semester=ii$I'> SEMESTER II </a></td></tr> ";
}
...
<th align='left'><font color='red' >POINT:</font></th></tr>";
