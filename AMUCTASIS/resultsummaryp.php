...
//-->
     ...
     <table width="488" height="36" border="0">
       <tr>
         <th width="482" height="32" scope="col"> <form id="form1" name="form1" method="get"  action="">
           <table width="447" height="44" border="0">
             <tr>
               <td width="80" height="40"><span class="style53">Select Year</span></td>
               <td width="81"><select name="Yearofstudy">
              ...
              ?>
               ...
               <td width="96">
                 <select name="semester">
                   <option value="i" selected="selected"><b>SEMESTER I</b></option>
			 ...
			 $k=1;
              ...
              echo" </select>";
			  ?></td>
               <td width="73"><input name="Save" type="submit" id="Save" value="OK" /></td>
             </tr>
           </table>
...
$page_name="resultsummaryp.php"; //  If you use this code with a different page ( or file ) name then change this 
$start=$_GET['start'];
...
echo "SEMESTER ".strtoupper($semester)." RESULT SUMMARY ".strtoupper($faculty)." FIRST YEAR STUDENTS  ";
}
...
echo "SEMESTER ".strtoupper($semester)." RESULT SUMMARY ".strtoupper($faculty)." SECOND YEAR STUDENTS  ";
}
if ($maxmam==3){



echo "SEMESTER ".strtoupper($semester)." RESULT SUMMARY ".strtoupper($faculty)."  THIRD YEAR STUDENTS  ";
}
...
echo"SEMESTER ".strtoupper($semester)." RESULT SUMMARY ".strtoupper($faculty)."  FORTH YEAR STUDENTS  ";
}
if ($maxmam==5){



echo "SEMESTER ".strtoupper($semester)." RESULT SUMMARY ".strtoupper($faculty)."  FIFTH YEAR STUDENTS  ";
}
}
echo"</center>";
$maxmam=0;
if ($v==0){
	...
	$qux="select * from courses where ((courses.faculty='$faculty')and (courses.course_year='$year' )and (courses.semester='$semester'));"; 
$rex=mysql_query($qux);
...
while($mark=mysql_fetch_array($rex)){
$f++;set_time_limit(0);	
$tt[$f]="".$mark['course_code']."";
echo"<th align='left'>";echo"".$mark['course_code']."";echo"</th>";
}
echo"</tr>";
$v++;
}
		   ...
		   $sio=0;
		   	 ...
		   	 for ($k=1;$k<=$f;$k++) {
			 set_time_limit(0);	 
			  $query211="select * from perfomance,courses where ((perfomance.id_no='".$laswai['id_no']."') and (perfomance.course_code=courses.course_code)and (courses.course_code='$tt[$k]'))";
$result21=mysql_query($query211);
$kapu=mysql_fetch_array($result21);
...
echo "<tr bgcolor='#ffdfaa'><td>$hh</td><td>".$laswai['id_no']."</td><td>".ucwords("".$laswai['name']."")."</td><td> ".$laswai['faculty']."</td>";}echo"<td>";

echo"".$kapu['marks']."";echo"</td>" ;
			  $a="2"; 			  
			 }
           else
              {
			...
			echo "<tr bgcolor='#EEEEEE'><td>$hh</td><td>".$laswai['id_no']."</td><td>".ucwords("".$laswai['name']."")."</td><td> ".$laswai['faculty']."</td>";}echo"<td>";
