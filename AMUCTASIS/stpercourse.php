     ...
     <table width="408" border="0" cellspacing="0" cellpadding="0">
       <tr>
         <td width="425" height="29"><strong><span class="style2">
           <marquee>
             <span class="style2 style52"> MY COURSES</span>
             </marquee>
         </span> </strong></td>
       </tr>
     </table>
...
$page_name="stpercourse.php"; //  If you use this code with a different page ( or file ) name then change this 
$start=$_GET['start'];
...
echo "<tr bgcolor='#6699CC'><th align='left'>C_CODE:</th><th align='left'>TITLE:</th><th align='left'>SEMESTER:</th><th align='left'>YEAR:</th><th align='left'>Year study:</th><th align='left'>View student:</th></tr>";
...
echo "<tr bgcolor='#ffdfaa'><td>".$laswai['course_code']."</td><td> ".$laswai['course_name']."</td><td> ".$laswai['semester']."</td><td>".$laswai['course_year']."</td><td>".$laswai['year']."</td><td><a href='staffstudent.php?Ni=$bn'>Student </a></td></tr>";  
...
echo "<tr bgcolor='#EEEEEE'><td>".$laswai['course_code']."</td><td> ".$laswai['course_name']."</td><td> ".$laswai['semester']."</td><td>".$laswai['course_year']."</td><td>".$laswai['year']."</td><td><a href='staffstudent.php?Ni=$bn'>Student</a></td></tr>";
			  $a="2"; 			  	
				 $a="1";
