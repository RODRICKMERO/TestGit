     ...
     <table width="408" border="0" cellspacing="0" cellpadding="0">
       <tr>
         <td width="425" height="29"><strong>
           <marquee>
             <span class="style35">VIEW USER </span>
             </marquee>
         </strong></td>
       </tr>
     </table>
...
$page_name="viewuser1.php"; //  If you use this code with a different page ( or file ) name then change this 
$start=$_GET['start'];
...
echo "<tr bgcolor='#6699CC'><th align='left'>S/N</th><th align='left'>USERNAME</th><th align='left'>ID_NO</th><th align='left'>GROUP</th></tr>";
...
$query=" select * from master_user2  where (master_user2.group  ='student' )order by id_no;";
$result=mysql_query($query);
$nume=mysql_num_rows($result);


echo '<table align="center" width="600" border="1" cellpadding="1" cellspacing="0" bordercolor="#000000">';
echo "<tr bgcolor='#6699CC'><th align='left'>USERNAME</th><th align='left'>ID_NO</th><th align='left'>GROUP</th></tr>";
    
$query2=" SELECT * FROM master_user2 where (master_user2.group  ='student') order by id_no limit $eu, $limit ";
$result2=mysql_query($query2);
echo mysql_error();
    ...
    while( $laswai=mysql_fetch_array($result2) )
	        {
		     ...
		     if($a==1)
			 {
			   ...
			   echo "<tr bgcolor='#66CCCC'><td>$no</td><td>".ucwords("".$laswai['name']."")."</td><td>".$laswai['id_no']."</td><td> ".$laswai['group']."</td></tr> " ;
			  $a="2"; 			  
			 }
           else
              {
			     
			   echo "<tr bgcolor='#EEEEEE'><td>$no</td><td>".ucwords("".$laswai['name']."")."</td><td>".$laswai['id_no']."</td><td> ".$laswai['group']."</td></tr> " ;
			  $a="2"; 			  
			  $a="1";
              }
			}
