...
$page_name="exuniversitydelete.php"; //  If you use this code with a different page ( or file ) name then change this 
$start=$_GET['start'];
...
$a="1";
$query=" select * from student2 order by id_no;";
...
echo "<tr bgcolor='#6699CC'><th>No</th><th align='left'>REGISTRATION NO:</th><th align='left'>STUDENT NAME:</th><th align='left'>FACULTY:</th><th  width='10%'>DEL STUDENT</tr>";


    
$query2=" SELECT * FROM student2 order by id_no limit $eu, $limit ";
...
echo "<tr bgcolor='#ffdfaa'><td>$ln</td><td>".strtoupper("".$laswai['id_no']."")."</td><td>  ".ucwords("".$laswai['name']."")."</td><td> ".strtoupper("".$laswai['faculty']."")."</td><td>";?>
     ...
     <?php 
			...
			echo "<tr bgcolor='#EEEEEE'><td>$ln</td><td>".strtoupper("".$laswai['id_no']."")."</td><td>  ".ucwords("".$laswai['name']."")."</td><td> ".strtoupper("".$laswai['faculty']."")."</td><td>";?>
     <input name="checkbox[]" type="checkbox" id="checkbox[]"  class="case"  value="<?php echo $laswai['id_no'];?>" />
     <?php echo'</td></tr>';?>
     <?php
			  $a="2"; 			  	
...
$quer= "INSERT INTO systemtracer values('','".date("20y-m-d")."',' STUDENT WAS  DELETED BY  ".$ngonyan['name']." WHO IS ".$ngonyan['group']." WITH REGISTRATION  ".$_SESSION['USERREG']." IN ".date("20y-m-d")." at ".time("h:m:s")."')";
$resul=mysql_query($quer);

$quer= "INSERT INTO systemtracer2 values('','".date("20y-m-d")."',' STUDENT WAS  DELETED BY ".$ngonyan['name']." WHO IS ".$ngonyan['group']." WITH REGISTRATION  ".$_SESSION['USERREG']." IN ".date("20y-m-d")." at ".time("h:m:s")."')";
$resul=mysql_query($quer);
mysql_error;
...
for($i=0;$i<$nume;$i++){
$del_id = $checkbox[$i];
$query3="DELETE FROM master_user WHERE (master_user.id_no='$del_id')";

	$query4="DELETE FROM student2 WHERE (student2.id_no='$del_id')";
	 $result3=mysql_query($query3);
	$result4=mysql_query($query4);
    $query5="DELETE FROM perfomance2 WHERE (perfomance2.id_no='$del_id')";
	$result5=mysql_query($query5);
	 $query51="DELETE FROM course_regsration2 WHERE (course_regsration2.id_no='$del_id')";
...
echo "<script language='javascript'>
                alert('selected student was deleted successfully');
				window.location='exuniversitydelete.php';
                </script>";
