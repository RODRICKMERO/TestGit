     ...
     <p align="center">  <table width="408" border="0" cellspacing="0" cellpadding="0">
       <tr>
         <td width="425" height="29"><strong><marquee>
           <span class="style35">EDIT  RESULT </span>
         </marquee>
         </strong></td>
       </tr>
     </table>     
...
$query="select  * from student,perfomance,course_regsration where ( (perfomance.course_code='$course_code') and(course_regsration.id_no=student.id_no)and(course_regsration.id_no=perfomance.id_no)and(course_regsration.course_code=perfomance.course_code)and(course_regsration.y_study='$y_study')and ((student.id_no=perfomance.id_no) and(student.faculty= '".$mero1['faculty']."')))order by name;";
