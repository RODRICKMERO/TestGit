...
//-->
 ...
 <?PHP
	 require("config.php");
	$mero1="select * from systemtracer2 ;";
$leo=mysql_query($mero1);

$me="select * from systemtracer2 ;";
$le=mysql_query($me);
$k=mysql_num_rows($le);
...
echo "".strtoupper("".$mero['change']."")."<a href='deletecourseu.php?sn=".$mero['sn']."  '><img BORDER='0' width='10' height='10' src='images/DEL.png' alt='[DELETE]'/> </a> " ;
echo"<p>";
 ...
 ?>  
         ...
         <a href="javascript:void(printSpecial())"><img src="images/b_print.png" border="0" height="20" width="20" alt="[print]" /></a><?php
	  ?> 
         </font>
         </marquee>
	   ...
	   <br />
	   <a href="untitledu.php?all=ok">[Delete All]</a>
	<?php   
	   
	   if($_GET['all']==ok){
	   
	   require("config.php");
 $query3="DELETE FROM systemtracer2 ";
	$result3=mysql_query($query3);
	echo "<script language='javascript'>
                alert('notification was deleted successfully');
				window.location='untitledu.php';
                </script>";
		}
	   ?>
     </div>
