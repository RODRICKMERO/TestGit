...
//-->
     ...
     <table width="408" border="0" cellspacing="0" cellpadding="0">
       <tr>
         <td width="425" height="29"><strong>
           <marquee>
             <span class="style46">PRINCIPAL'S HOME PAGE</span>
             </marquee>
         </strong></td>
       </tr>
     </table>
     ...
     <br />
     <table width="618" height="220" border="0" cellpadding="0" cellspacing="0">
       <tr>
         <td width="21" height="19">&nbsp;</td>
         <td width="597"> <div align="center"><strong>PRINCIPAL'S PRIVILEGES</strong></div></td>
       </tr>
       <tr>
         <td rowspan="5">&nbsp;</td>
         <td height="21" >1.Lists of Students : </td>
       </tr>
       
       <tr>
         <td height="21">2.Examination results</td>
       </tr>
       
       <tr>
         <td height="19">3.System changes report</td>
       </tr>
       <tr>
         <td height="19">4.Upload announcements</td>
       </tr>
       <tr>
         <td height="19">5.View announcements</td>
       </tr>
       <tr>
         <td>&nbsp;</td>
       ...
       <tr>
         <td>&nbsp;</td>
         <td height="19">7.General summary</td>
       </tr>
       <tr>
         <td>&nbsp;</td>
         <td height="31">&nbsp;</td>
