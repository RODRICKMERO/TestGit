...
//-->
     ...
     <br />
     <br />
     <form action="addcourse2.php" method="post" enctype="multipart/form-data">
       <table width="560" height="290">
         <tr> </tr>
         <tr>
           <td width="245" height="35" align="center" valign="top"><div align="center">COURSE CODE </div></td>
           <td width="266" height="35" align="right" valign="top"><div align="left"> <span id="sprytextfield1">
             <label>
         ...
         <tr>
           <td width="245" height="30" valign="top" align="center"><div align="center"><strong>COURSE NAME </strong></div></td>
           <td width="266" height="30" valign="top" align="right"><span id="sprytextfield2">
             <label> </label>
             <div align="left">
               <input type="text" name="cosname" size="20" id="cosname" />
               <span class="textfieldRequiredMsg">Avalue is required</span></div>
             <span class="textfieldRequiredMsg">.</span></span></td>
</tr>
         <tr>
           <td width="245" height="30" valign="top" align="center"><div align="center">UNIT</div></td>
           <td width="266" height="30" valign="top" align="right"><div align="left"> <span id="sprytextfield3">
             <label>
               <input type="text" name="unit" size="20" id="unit" />
               </label>
         ...
         <tr>
           <td width="245" height="26" valign="top" align="center"><strong>SEMESTER</strong></td>
           <td><div align="left">
         ...
         <tr>
           <td height="26" valign="top" align="center"><strong>COMMENT</strong></td>
           <td><div align="left">
             <select name="comment">
               <option value="core" selected="selected"><b>CORE</b></option>
               <option value="option">OPTION</option>
             </select>
           </div></td>
         </tr>
         <tr>
           <td width="245" height="26" valign="top" align="center"><strong>COURSE INFO</strong></td>
           <td><div align="left">
         ...
         <tr>
           <td height="45"><div align="justify">
             <table width="278" height="38" border="0">
               <tr>
                 <th width="64" scope="row"></th>
                 <td height="24" width="51" align="center"><a href="logout.php"></a></td>
