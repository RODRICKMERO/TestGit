     ...
     <table width="408" border="0" cellspacing="0" cellpadding="0">
       <tr>
         <td width="425" height="29"><strong><span class="style2">
           <marquee>
             <span class="style2 style52">  COURSEWORK RESULTS </span>
             </marquee>
         </span> </strong></td>
       </tr>
     </table>
...
$page_name="coseresulty.php"; //  If you use this code with a different page ( or file ) name then change this 
$start=$_GET['start'];
...
$query="select  * from courses,staffcourse where ((staffcourse.course_code= courses.course_code) and (staffcourse.id_no= '".$_SESSION['USERREG']."'))order by year;";
...
echo "<tr bgcolor='#6699CC'><th align='left'>C_CODE:</th><th align='left'>TITLE:</th><th align='left'>SEMESTER:</th><th align='left'>YEAR:</th><th align='left'>Year study:</th><th align='left'>View Resulty:</th></tr>";
 
$query2="select  * from courses,staffcourse where ((staffcourse.course_code= courses.course_code) and (staffcourse.id_no= '".$_SESSION['USERREG']."')) order by year limit $eu, $limit "; 
...
echo mysql_error();
    ...
    while( $laswai=mysql_fetch_array($result2) )
	        {
			  $bn="".$laswai['year'].""."".$laswai['course_code']."";
		     if($a==1)
			 {
			 
echo "<tr bgcolor='#ffdfaa'><td>".$laswai['course_code']."</td><td> ".$laswai['course_name']."</td><td> ".$laswai['semester']."</td><td>".$laswai['course_year']."</td><td>".$laswai['year']."</td><td><a href='coseworkresulty.php?Ni=$bn'>Resulty </a></td></tr>";  
...
echo "<tr bgcolor='#EEEEEE'><td>".$laswai['course_code']."</td><td> ".$laswai['course_name']."</td><td> ".$laswai['semester']."</td><td>".$laswai['course_year']."</td><td>".$laswai['year']."</td><td><a href='coseworkresulty.php?Ni=$bn'>Resulty</a></td></tr>";
			  $a="2"; 			  	
				 $a="1";
