...
{
$page_name="exuniversityresult.php"; //  If you use this code with a different page ( or file ) name then change this 
$start=$_GET['start'];
...
$eu = ($start - 0);
$limit = 12000;                                 // No of records to be shown per page.
$this1 = $eu + $limit; 
$back = $eu - $limit; 
$next = $eu + $limit; 
...
$query="SELECT * FROM student2 where student2.id_no='".$_SESSION['USERRE']."' order by id_no;";
...
echo" </font></center>";
echo"<center><font face='verdana' color='red'> SELECT YEAR AND SEMESTER  or <a href='progressivex.php?'> VIEW PROGRESS </a></center><br> </font>";
}


$query1="select distinct * from perfomance2,courses where ((perfomance2.id_no='".$_SESSION['USERRE']."') and (perfomance2.course_code=courses.course_code)and(courses.faculty='".$mero['faculty']."'));"; 
...
$querya="select * from perfomance2,courses where ((perfomance2.id_no='".$_SESSION['USERRE']."') and (perfomance2.course_code=courses.course_code)and(courses.faculty='".$mero['faculty']."')) order by course_year,semester ;"; 
...
{
echo"<tr><td rowspan='2'> YEAR $I </td><td><a href='resultex.php?semester=i$I'> SEMESTER I </a></td>";

echo"<td rowspan='2'><a href='resultex.php?course_year=$I'> OVARALL YEAR $I </a></td></tr><tr><td><a href='resultex.php?semester=ii$I'> SEMESTER II </a></td></tr> ";}else
{
echo"<tr><td rowspan='2'> YEAR $I </td><td><a href='resultex.php?semester=i$I'> SEMESTER I </a></td>";
if($SEME=="II")
{
echo"<td rowspan='2'><a href='resultex.php?course_year=$I'> OVARALL YEAR $I </a></td></tr><tr><td><a href='resultex.php?semester=ii$I'> SEMESTER II </a></td></tr> ";
}
...
$result=mysql_query($query);
$mero=mysql_fetch_array($result);
$query2="select * from perfomance2,courses where ((perfomance2.id_no='".$_SESSION['USERRE']."') and (perfomance2.course_code=courses.course_code)and(courses.faculty='".$mero['faculty']."'));"; 
$result2=mysql_query($query2);
echo mysql_error();
             $TOTALPOINT=0; $TOTALUNIT=0; $F=1;
...
echo"".$martha['course_unit']."";echo"</td>";echo"<td>";echo"".$martha['score']."";echo"</td>";
