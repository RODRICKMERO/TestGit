...
$eu = ($start - 0); 
$limit = 2000000;                                 // No of records to be shown per page.
$this1 = $eu + $limit; 
$back = $eu - $limit; 
$next = $eu + $limit; 
...
for($i=0;$i<$nume;$i++){
$del_id = $checkbox[$i];
$query3="DELETE FROM master_user2 WHERE (master_user2.id_no='$del_id')";

	$query4="DELETE FROM student WHERE (student.id_no='$del_id')";
	 $result3=mysql_query($query3);
	$result4=mysql_query($query4);
    $query5="DELETE FROM perfomance WHERE (perfomance.id_no='$del_id')";
	$result5=mysql_query($query5);
	 $query51="DELETE FROM course_regsration WHERE (course_regsration.id_no='$del_id')";
