     ...
     <table width="408" border="0" cellspacing="0" cellpadding="0">
       <tr>
         <td width="425" height="29"><strong>
           <marquee>
             <span class="style35">LIST OF STUDENTS</span>
           </marquee>
         </strong></td>
       </tr>
     </table>
...
$page_name="staffstudent.php"; //  If you use this code with a different page ( or file ) name then change this 
$start=$_GET['start'];
...
$query="select  * from student,course_regsration where ((course_regsration.y_study='$y_study') and (course_regsration.course_code='$course_code') and (student.id_no=course_regsration.id_no));";
$result=mysql_query($query);
$nume=mysql_num_rows($result);
?>
     <div id="printReady">
       <?php
echo ' <font color="blue"><center>';echo"These are Students Registerd in $course_code $y_study";echo ' </font></center>';
echo '<table align="center" width="" border="1" cellpadding="2" cellspacing="0" bordercolor="#66cccc">';
echo "<tr bgcolor='#6699CC'><th align='left'>SN:</th><th align='left'>STUDENT NAME:</th><th align='left'>REG_NO:</th></tr>";
 $query2="select  * from student,course_regsration where ((course_regsration.y_study='$y_study') and (course_regsration.course_code='$course_code') and (student.id_no=course_regsration.id_no))limit $eu, $limit "; 
...
echo "<tr bgcolor='#ffdfaa'><td>$sn</td><td>".ucwords("".$laswai['name']."")."</td><td> ".$laswai['id_no']."</td></tr> " ;
...
echo "<tr bgcolor='#eeeeee'><td>$sn</td><td>".ucwords("".$laswai['name']."")."</td><td> ".$laswai['id_no']."</td></tr> " ;
