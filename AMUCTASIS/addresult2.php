...
$query71="UPDATE perfomance SET perfomance.marks='$marks' WHERE ( (perfomance.course_code='$code') and( perfomance.id_no='$reg'));";
$result71=mysql_query($query71);
$query712="UPDATE perfomance SET perfomance.remarks='$remarks' WHERE ( (perfomance.course_code='$code') and( perfomance.id_no='$reg'));";
$result712=mysql_query($query712);
$query7="UPDATE perfomance SET perfomance.score='$score' WHERE ( (perfomance.course_code='$code') and( perfomance.id_no='$reg'));";
...
$quer= "INSERT INTO systemtracer values('','".date("20y-m-d")."',' EXAMINATION RESULTY WAS EDITED IN THE SYSTEM BY THE DEAN OF FACULTY OF ".$ngonyan['faculty']."  WITH THE NAME ".$ngonyan['name']." AND ".$_SESSION['USERREG']." REGSRATION NUMBER IN ".date("20y-m-d")." at ".time("h:m:s")."')";
$resul=mysql_query($quer);

$quer= "INSERT INTO systemtracer2 values('','".date("20y-m-d")."',' EXAMINATION RESULTY WAS EDITED IN THE SYSTEM BY THE DEAN OF FACULTY OF ".$ngonyan['faculty']."  WITH THE NAME ".$ngonyan['name']." AND ".$_SESSION['USERREG']." REGSRATION NUMBER IN ".date("20y-m-d")." at ".time("h:m:s")."')";
$resul=mysql_query($quer);
if(!$result7){
echo"err";
...
$page_name="addresult2.php"; //  If you use this code with a different page ( or file ) name then change this 
$start=$_GET['start'];
...
$tyy="select * from course_regsration where ((course_regsration.id_no='$reg')and(course_regsration.course_code='$course_code'))";
$t=mysql_query($tyy);
...
echo"<color='red'>";
echo"<center>";
 echo"THIS ARE $course_code  RESULT YEAR ".$mero12['course_year']." COURSE FOR SEMESTER  ".$mero12['semester']." "; 
...
$COUNT=0;
?>
     <table width="64%" height="20" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#66cccc" cols="0" >
       <tr bgcolor='#6699CC'>
         <th width="9%" height="40" align='left'><span class="style3">S/N:</span></th>
         ...
         <th  width='30%'><span class="style3">OK</span></th>
       </tr>
       <?php
...
echo "<tr bgcolor='#ffdfaa'><td>$COUNT</td><td>".$laswai['name']."</td>";
?>
       
       <form id='form1' name='form1' method='post'  action='addresult2.php'>
      
       <?php

        echo" <td>";echo"<select name='reg'>";
 echo" <option value='".$laswai['id_no']."'>"; echo"<b>"; echo"".strtoupper("".$laswai['id_no']."").""; echo"</b>"; echo"</option>";
     echo"</select>";
    echo" </td>";
	
	 echo" <td>";echo"<select name='code'>";
 echo" <option value='$course_code'>"; echo"<b>"; echo"$course_code"; echo"</b>"; echo"</option>";
     echo"</select>";
    echo" </td>";
	 echo" <td>";

     echo"<input type='text' name='marks'  value='".strtoupper("".$laswai['marks']."")."' size='5'/>";
	
	  echo" </td>";
	
	  echo" <td>".strtoupper("".$laswai['score']."")."";
	 echo" </td>";
	  echo" <td>"; ?>
       <input name='get' type='submit' id='save' value='OK' />
       <?php echo"</td>";
      echo" </tr>";
...
echo "<tr bgcolor='#eeeeee'><td>$COUNT</td><td>".$laswai['name']."</td>"; 
?>
       <form id='form1' name='form1' method='post'  action='addresult2.php'>
         <?php
...
?>
     <script type="text/javascript">
<!--
var sprytextfield1 = new Spry.Widget.ValidationTextField("sprytextfield2", "none", {validateOn:["change"]});
var sprytextfield3 = new Spry.Widget.ValidationTextField("sprytextfield3", "none", {validateOn:["change"]});
//-->
     </script>
