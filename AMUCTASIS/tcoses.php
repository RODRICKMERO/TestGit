...
$quer= "INSERT INTO systemtracer values('','".date("20y-m-d")."',' COURSE ALLOCATION WAS CONDUCTED BY DPAA  WITH THE NAME ".$ngonyan['name']." AND ".$_SESSION['USERREG']." REGSRATION NUMBER IN ".date("20y-m-d")." at ".time("h:m:s")."')";
$resul=mysql_query($quer);

$quer= "INSERT INTO systemtracer2 values('','".date("20y-m-d")."',' COURSE ALLOCATION WAS CONDUCTED BY DPAA  WITH THE NAME WITH THE NAME ".$ngonyan['name']." AND ".$_SESSION['USERREG']." REGSRATION NUMBER IN ".date("20y-m-d")." at ".time("h:m:s")."')";
$resul=mysql_query($quer);
mysql_error;
...
$sql = "insert into staffcourse set
id_no='$idno',
