...
{
$page_name="viewresultprincipalu.php"; //  If you use this code with a different page ( or file ) name then change this 
$start=$_GET['start'];
...
$eu = ($start - 0);
$limit = 12000000;                                 // No of records to be shown per page.
$this1 = $eu + $limit; 
$back = $eu - $limit; 
$next = $eu + $limit; 
...
echo" </font></center>";
echo"<center><font face='verdana' color='red'> SELECT YEAR AND SEMESTER  or <a href='progressivepu.php?'> VIEW PROGRESS </a></center><br> </font>";
}


$query1="select distinct * from perfomance,courses where ((perfomance.id_no='".$_SESSION['USERRE']."') and (perfomance.course_code=courses.course_code));"; 
...
$querya="select * from perfomance,courses where ((perfomance.id_no='".$_SESSION['USERRE']."') and (perfomance.course_code=courses.course_code)) order by course_year,semester ;"; 
...
{
echo"<tr><td rowspan='2'> YEAR $I </td><td><a href='resultprincipalu.php?semester=i$I'> SEMESTER I </a></td>";

echo"<td rowspan='2'><a href='resultprincipalu.php?course_year=$I'> OVARALL YEAR $I </a></td></tr><tr><td><a href='resultprincipalu.php?semester=ii$I'> SEMESTER II </a></td></tr> ";}else
{
echo"<tr><td rowspan='2'> YEAR $I </td><td><a href='resultprincipalu.php?semester=i$I'> SEMESTER I </a></td>";
if($SEME=="II")
{
echo"<td rowspan='2'><a href='resultprincipalu.php?course_year=$I'> OVARALL YEAR $I </a></td></tr><tr><td><a href='resultprincipalu.php?semester=ii$I'> SEMESTER II </a></td></tr> ";
}
...
$query2="select * from perfomance,courses where ((perfomance.id_no='".$_SESSION['USERRE']."') and (perfomance.course_code=courses.course_code));"; 
