...
$page_name="viewstudentprincipal.php"; //  If you use this code with a different page ( or file ) name then change this 
$start=$_GET['start'];
...
echo "<tr bgcolor='#ffdfaa'><td>$namba</td><td>".$laswai['id_no']."</td><td>".ucwords("".$laswai['name']."")."</td><td> ".$laswai['faculty']."</td><td><a href='viewresultprincipal.php?N=".$laswai['id_no']."'>RESULT </a></td></tr> " ;
			  $a="2"; 			  
			 }
           else
              {
			...
			echo "<tr bgcolor='#EEEEEE'><td>$namba</td><td>".$laswai['id_no']."</td><td> ".ucwords("".$laswai['name']."")."</td><td> ".$laswai['faculty']."</td><td><a href='viewresultprincipal.php?N=".$laswai['id_no']."'>RESULT </a></td></tr> " ;
			  $a="2"; 			  	
				 $a="1";
