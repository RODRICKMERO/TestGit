     ...
     <table width="408" border="0" cellspacing="0" cellpadding="0">
       <tr>
         <td width="425" height="29"><strong>
           <marquee>
             <span class="style35"> RESULT PAGE </span>
             </marquee>
         </strong></td>
       </tr>
     </table>
...
$query="SELECT * FROM student where student.id_no='".$_SESSION['USERREG']."' order by id_no;";
...
echo"                                            NAME               : ".ucwords("".$mero['name']."")." .<br>";
echo"                                            REGISTRATION NUMBER  : ".$_SESSION['USERREG']."";
echo"<p>";echo"</p>";
...
$query1="select distinct * from perfomance,courses where ((perfomance.id_no='".$_SESSION['USERREG']."') and (perfomance.course_code=courses.course_code)and(courses.faculty='".$mero['faculty']."'));"; 
...
$querya="select * from perfomance,courses where ((perfomance.id_no='".$_SESSION['USERREG']."') and (perfomance.course_code=courses.course_code)and(courses.faculty='".$mero['faculty']."')) order by course_year,semester ;"; 
...
{
echo"<tr><td rowspan='2'> YEAR $I </td><td><a href='result.php?semester=i$I'> SEMESTER I </a></td>";

echo"<td rowspan='2'><a href='result.php?course_year=$I'> OVARALL YEAR $I </a></td></tr><tr><td><a href='result.php?semester=ii$I'> SEMESTER II </a></td></tr> ";}else
{
echo"<tr><td rowspan='2'> YEAR $I </td><td><a href='result.php?semester=i$I'> SEMESTER I </a></td>";
if($SEME=="II")
{
echo"<td rowspan='2'><a href='result.php?course_year=$I'> OVARALL YEAR $I </a></td></tr><tr><td><a href='result.php?semester=ii$I'> SEMESTER II </a></td></tr> ";
}
...
$result=mysql_query($query);
$mero=mysql_fetch_array($result);
$query2="select * from perfomance,courses where ((perfomance.id_no='".$_SESSION['USERREG']."') and (perfomance.course_code=courses.course_code)and(courses.faculty='".$mero['faculty']."'));"; 
...
echo "<tr bgcolor='#ffdfaa'>";echo"<td>";echo"".strtoupper("".$martha['course_code']."")."";echo"</td>";echo"<td>";echo"".ucfirst("".$martha['course_name']."")."";echo"</td>";echo"<td>"; 
...
echo"            TOTAL UNIT =  $TOTALUNIT     TOTAL SCORED POINT =  $TOTALPOINT      AND  YOUR  GPA IS " .round($GPA,2);
 echo"</center></p>";}
echo "<p><hr width='70%' />";
