...
.style461 {color: #0000FF; font-size: 18px; }
.style461 {color: #0080FF}
-->
</style>
</head>
...
$page_name="selectcourse.php"; //  If you use this code with a different page ( or file ) name then change this 
$start=$_GET['start'];
...
$a="1";
$query="select  * from courses where courses.faculty=(select faculty from student where (student.name='".$_SESSION['USER']."')AND 
(student.id_no='".$_SESSION['USERREG']."'))order by course_year;";
$result=mysql_query($query);
$nume=mysql_num_rows($result);

echo '<table align="center" width="" border="1" cellpadding="2" cellspacing="0" bordercolor="#66cccc">';
echo "<tr bgcolor='#6699CC'><th align='left'>C_CODE:</th><th align='left'>COURSE NAME:</th><th align='left'>FACULTY:</th><th align='left'>YEAR:</th></tr>";
 
$query2="select distinct * from courses where courses.faculty=(select faculty from student where (student.name='".$_SESSION['USER']."')AND 
...
echo "<tr bgcolor='#ffdfaa'><td>".strtoupper("".$laswai['course_code']."")."</td><td> ".ucfirst("".$laswai['course_name']."")."</td><td> ".strtoupper("".$laswai['faculty']."")."</td><td>".$laswai['course_year']."</td></tr> " ;
			  $a="2"; 			  
			 }
           else
              {
			  			   
echo "<tr bgcolor='#EEEEEE'><td>".strtoupper("".$laswai['course_code']."")."</td><td> ".ucfirst("".$laswai['course_name']."")."</td><td> ".strtoupper("".$laswai['faculty']."")."</td><td>".$laswai['course_year']."</td></tr> " ;
...
?>
     <table width="200" height="151" border="0">
       <tr>
         <th height="147" scope="col"> <form id="form1" name="form1" method="get"  action="mycourse.php?">
           <table width="200" border="0">
             <tr>
               <th scope="col"><div align="left" class="style461">Select Semester &amp; Year of Study </div></th>
             </tr>
             <tr>
             ...
             <tr>
               <td><input name="Save" type="submit" id="Save" value="OK" /></td>
             </tr>
           </table>
