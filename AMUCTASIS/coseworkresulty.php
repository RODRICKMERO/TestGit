...
$page_name="coseworkresulty.php"; //  If you use this code with a different page ( or file ) name then change this 
$start=$_GET['start'];
...
$sn=0;
$query="select  * from student,coursework where ((coursework.year='$y_study') and (coursework.course_code='$course_code') and (student.id_no=coursework.id_no));";
$result=mysql_query($query);
$nume=mysql_num_rows($result);
?>
     <div id="printReady">
       <?php
echo ' <font color="blue"><center>';echo"This is $course_code Coursework Results  in  $y_study";echo ' </font></center>';

echo '<table align="center" width="" border="1" cellpadding="2" cellspacing="0" bordercolor="#66cccc">';
echo "<tr bgcolor='#6699CC'><th align='left'>SN:</th><th align='left'>STUDENT NAME:</th><th align='left'>REG_NO:</th><th align='left'>MARKS:</th></tr>";
 $query2="select  * from student,coursework where ((coursework.year='$y_study') and (coursework.course_code='$course_code') and (student.id_no=coursework.id_no))limit $eu, $limit "; 
...
echo "<tr bgcolor='#ffdfaa'><td>$sn</td><td>".ucwords("".$laswai['name']."")."</td><td> ".$laswai['id_no']."</td><td> ".$laswai['marks']."</td></tr> " ;
...
echo "<tr bgcolor='#eeeeee'><td>$sn</td><td>".ucwords("".$laswai['name']."")."</td><td> ".$laswai['id_no']."</td><td> ".$laswai['marks']."</td></tr> " ;
