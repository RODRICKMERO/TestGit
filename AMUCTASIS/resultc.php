...
$page_name="resultc.php"; //  If you use this code with a different page ( or file ) name then change this 
$start=$_GET['start'];
...
$query1="select distinct * from coursework,courses where ((coursework.id_no='".$_SESSION['USERREG']."') and (coursework.course_code=courses.course_code)and(courses.faculty='".$mero['faculty']."'));"; 
...
$querya="select distinct * from coursework,courses where ((coursework.id_no='".$_SESSION['USERREG']."') and (coursework.course_code=courses.course_code)and(courses.faculty='".$mero['faculty']."')) order by course_year,semester ;"; 
...
{
echo"<tr><td rowspan='2'> YEAR $I </td><td><a href='resultc.php?semester=i$I'> SEMESTER I </a></td>";

echo"<tr><td><a href='resultc.php?semester=ii$I'> SEMESTER II </a></td></tr> ";}else
{
echo"<tr><td rowspan='2'> YEAR $I </td><td><a href='resultc.php?semester=i$I'> SEMESTER I </a></td>";
if($SEME=="II")
{
echo"<tr><td><a href='resultc.php?semester=ii$I'> SEMESTER II </a></td></tr> ";
}
...
$result=mysql_query($query);
$mero=mysql_fetch_array($result);
$query2="select * from coursework,courses where ((coursework.id_no='".$_SESSION['USERREG']."') and (coursework.course_code=courses.course_code)and(courses.faculty='".$mero['faculty']."'));"; 
