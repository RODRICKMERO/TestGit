     ...
     <table width="408" border="0" cellspacing="0" cellpadding="0">
       <tr>
         <td width="425" height="29"><strong>
           <marquee>
             <span class="style46">Transifer Students</span>
             </marquee>
         </strong></td>
       </tr>
     </table>
       ...
       <tr>
         <th height="32" scope="col"> <form id="form1" name="form1" method="get"  action="">
           <table width="396" border="0">
             <tr>
               <td width="148" height="26"><span class="style53">Select faculty &amp; Year</span></td>
               <td width="196"><select name="Yearofstudy">
              ...
              ?>
               ...
               <td width="38"><input name="Save" type="submit" id="Save" value="OK" /></td>
             </tr>
           </table>
...
$page_name="transifer.php"; //  If you use this code with a different page ( or file ) name then change this 
$start=$_GET['start'];
...
?>
        ...
        <tr>
           ...
           <td> 
             <select name="reason">
               <option value="Completed" selected="selected"><b>COMPLETED</b></option>
               <option value="Postiponed">POSTPONED</option>
...
echo "<tr bgcolor='#6699CC'><th align='left'>S/N</th><th align='left'>REG No:</th><th align='left'>STUDENT NAME:</th><th align='left'>FACULTY:</th><th align='left'>SELECT</th></tr>";
$v++;
}  $hh++;
		     if($a==1)
			{ 
...
echo "<tr bgcolor='#ffdfaa'><td>$hh</td><td>".$laswai['id_no']."</td><td>".ucwords("".$laswai['name']."")."</td><td> ".$laswai['faculty']."</td><td>";?>
     ...
     <?php  echo'</td></tr>';
			...
			echo "<tr bgcolor='#EEEEEE'><td>$hh</td><td>".$laswai['id_no']."</td><td> ".ucwords("".$laswai['name']."")."</td><td> ".$laswai['faculty']."</td><td>";?>
     <input name="checkbox[]" type="checkbox" id="checkbox[]"  class="case"  value="<?php echo $laswai['id_no'];?>" />
     <?php  echo'</td></tr>';
			  $a="2"; 			  	
				 $a="1";
...
if (!empty($del_id)){
set_time_limit (0) ;
$q1="select * from master_user2 where (master_user2.id_no='$del_id')";
 $r1=mysql_query($q1);
 
$dq1="delete from master_user2 where (master_user2.id_no='$del_id')";
 $dr1=mysql_query($dq1);

 
 $q2="select * from perfomance where (perfomance.id_no='$del_id')";
 $r2=mysql_query($q2);
 
 $dq2="delete from perfomance where (perfomance.id_no='$del_id')";
 $dr2=mysql_query($dq2);
 
 $q3="select * from course_regsration where (course_regsration.id_no='$del_id')";
 $r3=mysql_query($q3);
 
 $dq3="delete from course_regsration where (course_regsration.id_no='$del_id')";
 $dr3=mysql_query($dq3);
 ...
 $q5="select * from student where (student.id_no='$del_id')";
 $r5=mysql_query($q5);
 
 $dq5="delete from student where (student.id_no='$del_id')";
 $dr5=mysql_query($dq5);

 while( $ar1=mysql_fetch_array($r1)){
 set_time_limit (0) ;
	 
	$q1i="insert into master_user values('".$ar1['id_no']."','".$ar1['name']."','".$ar1['user_password']."','".$ar1['group']."')";
	$r1i=mysql_query($q1i); 
  ...
  while( $ar2=mysql_fetch_array($r2)){
	...
	$q2i="insert into perfomance2 values('".$ar2['id_no']."','".$ar2['exam_no']."','".$ar2['course_code']."','".$ar2['marks']."','".$ar2['score']."','".$ar2['remarks']."')";
	$r2i=mysql_query($q2i);
  ...
  while( $ar3=mysql_fetch_array($r3)){
	...
	$q3i="insert into course_regsration2 values('".$ar3['id_no']."','".$ar3['course_code']."','".$ar3['regDate']."','".$ar3['y_study']."')";
	$r3i=mysql_query($q3i); 
	 
 }
 if($great>0){
	 $q6="insert into user_status values('$id','$grea','$reason')";
	$r6=mysql_query($q6); 
  ...
  while( $ar4=mysql_fetch_array($r4)){
	...
	$q4i="insert into pamission2 values('".$ar4['id_no']."','".$ar4['older']."','".$ar4['disid']."')";
	$r4i=mysql_query($q4i); 
...
$q5i="insert into student2 values('".$ar5['id_no']."','".$ar5['name']."','".$ar5['faculty']."','".$ar5['level']."')";
	$r5i=mysql_query($q5i);	 
