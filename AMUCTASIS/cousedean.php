     ...
     <table width="408" border="0" cellspacing="0" cellpadding="0">
       <tr>
         <td width="425" height="29"><strong>
           <marquee>
             <span class="style35">STUDENT COUSES</span>
             </marquee>
         </strong></td>
       </tr>
     </table>
...
{
$page_name="cousedean.php"; //  If you use this code with a different page ( or file ) name then change this 
$start=$_GET['start'];
...
$query1="select distinct * from course_regsration,courses where ((course_regsration.id_no='".$_SESSION['USERRE']."') and (course_regsration.course_code=courses.course_code)and(courses.faculty='".$mero['faculty']."') );"; 
...
$querya="select * from course_regsration,courses where ((course_regsration.id_no='".$_SESSION['USERRE']."') and (course_regsration.course_code=courses.course_code)and(courses.faculty='".$mero['faculty']."') ) order by course_year,semester ;"; 
...
$query2="select * from course_regsration,courses where ((course_regsration.id_no='".$_SESSION['USERRE']."') and (course_regsration.course_code=courses.course_code)and(courses.faculty='".$mero['faculty']."'));"; 
