...
$page_name="universitystudent.php"; //  If you use this code with a different page ( or file ) name then change this 
$start=$_GET['start'];
...
echo "<tr bgcolor='#6699CC'><th>No</th><th align='left'>REG No:</th><th align='left'>STUDENT NAME:</th><th align='left'>FACULTY:</th></tr>";
$v++;
}
		  $namba++;
		  if($a==1)
...
echo "<tr bgcolor='#ffdfaa'><td>$namba</td><td>".$laswai['id_no']."</td><td>".ucwords("".$laswai['name']."")."</td><td> ".$laswai['faculty']."</td></tr> " ;
			  $a="2"; 			  
			 }
           else
              {
...
echo "<tr bgcolor='#EEEEEE'><td>$namba</td><td>".$laswai['id_no']."</td><td> ".ucwords("".$laswai['name']."")."</td><td> ".$laswai['faculty']."</td></tr> " ;
			  $a="2"; 			  	
				 $a="1";
