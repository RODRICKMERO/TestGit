...
//-->
     ...
     <table width="408" border="0" cellspacing="0" cellpadding="0">
       <tr>
         <td width="425" height="29"><strong>
           <marquee>
             <span class="style46">UPLOAD ANNOUNCEMENT</span>
             </marquee>
         </strong></td>
       </tr>
     </table>
  ...
  <form action="announcementp.php" name="exp" method="post" enctype="multipart/form-data">
    <table width="443" border="1">
    <tr>
           <td width="114" height="26" align="center" valign="top">Title</td>
           <td width="297" height="26" align="right" valign="top"><div align="left"> <span id="sprytextfield1">
             <label>
               <input type="text" name="title" size="20" id="user_name" />
             </label>
             <span class="textfieldRequiredMsg">Avalue is required.</span></span></div></td>
         </tr>

      <tr>
        <td width="114" class="line2">CATEGORY:</td>
        <td width="297" align="left" class="line2"><select name="group">
                 <option value="student" selected="selected"><b>STUDENT</b></option>
      ...
      <tr>
        <td class="line2">Expirydate:</td>
        <td align="left" valign="middle" class="line2"><div align="left"><span id="spryIdate">
          <label>
            <input type='text' name='xdate'  size="22"/>
            <input name="button" type="button" onclick="displayDatePicker('xdate',false,'ymd', '-');" value="Calender" />
          </label>
          <span class="textfieldRequiredMsg">A value is required.</span></span></div></td>
      </tr>
      <tr>
        <td class="line2">File:</td>
        <td align="left" valign="middle" class="line2"> <input name="userfile" type="file" id="userfile2" size="22" />
</td>
        </tr>
      <tr>
        <td class="line2">&nbsp;</td>
        <td align="left" valign="middle" class="line2"><input name="upload" type="submit" class="box" id="upload" value=" send " />
     ...
     <p> </p>
     <div id="wb_MenuBar1" style="position:absolute; left:142px; top:121px; width:92px; height:22px; z-index:1001;">
       <div id="MenuBar1">
