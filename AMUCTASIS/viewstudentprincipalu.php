...
$page_name="viewstudentprincipalu.php"; //  If you use this code with a different page ( or file ) name then change this 
$start=$_GET['start'];
...
$eu = ($start - 0); 
$limit = 20000;                                 // No of records to be shown per page.
$this1 = $eu + $limit; 
$back = $eu - $limit; 
$next = $eu + $limit; 
...
echo "<tr bgcolor='#6699CC'><th>No</th><th align='left'>REG No:</th><th align='left'>STUDENT NAME:</th><th align='left'>FACULTY:</th><th align='left'>RESULT:</th></tr>";
$v++;
}
		  $namba++;
		  if($a==1)
...
echo "<tr bgcolor='#ffdfaa'><td>$namba</td><td>".$laswai['id_no']."</td><td>".ucwords("".$laswai['name']."")."</td><td> ".$laswai['faculty']."</td><td><a href='viewresultprincipalu.php?N=".$laswai['id_no']."'>RESULT </a></td></tr> " ;
			  $a="2"; 			  
			 }
           else
              {
			...
			echo "<tr bgcolor='#EEEEEE'><td>$namba</td><td>".$laswai['id_no']."</td><td> ".ucwords("".$laswai['name']."")."</td><td> ".$laswai['faculty']."</td><td><a href='viewresultprincipalu.php?N=".$laswai['id_no']."'>RESULT </a></td></tr> " ;
			  $a="2"; 			  	
				 $a="1";
