     ...
     <table width="408" border="0" cellspacing="0" cellpadding="0">
       <tr>
          <td width="425" height="29"><strong>
            <marquee>
              <span class="style35"> REGISTRAR HOME PAGE </span>
              </marquee>
          </strong></td>
        </tr>
      </table>
      ...
      <table width="618" height="274" border="0" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <td width="597"><div align="center" class="style50">REGISTRAR'S PRIVILEGES</div></td>
        </tr>
        <tr>
          <td rowspan="8">&nbsp;</td>
          <td height="21">1. Add Students using excel data entry sheet(CSV)<strong>: </td>
        </tr>
        
        <tr>
          <td height="18">2. Delete Students(consult IT personnel )</td>
        </tr>
        
        <tr>
          <td height="18">3. Disable/ Enable Students</span>:</td>
        </tr>
        
        <tr>
          <td height="19">4. Transfer information to backup</td>
        </tr>
        <tr>
          <td height="19">5. Transifer information from backup</td>
        </tr>
        <tr>
          <td height="19">6. Alumni</td>
        </tr>
        <tr>
          <td height="19">7. Students password editing.</td>
        </tr>
        <tr>
          <td height="19">8. General summary</td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td height="19">9. Announcements</td>
        </tr>
      </table>
      <script type="text/javascript">
<!--
