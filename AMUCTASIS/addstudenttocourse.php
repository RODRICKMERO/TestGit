...
<table width="408" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="425" height="29"><strong>
      <marquee>
        <span class="style35">Upload csv file</span>
        </marquee>
      </strong></td>
    </tr>
</table>
...
$quer= "INSERT INTO systemtracer values('','".date("20y-m-d")."',' STUDENTS WERE REGISTERED TO COURSE  BY THE DEAN OF FACULTY OF ".$ngonyan['faculty']."  WITH THE NAME ".$ngonyan['name']." AND ".$_SESSION['USERREG']." REGSRATION NUMBER IN ".date("20y-m-d")." at ".time("h:m:s")."')";
$resul=mysql_query($quer);

$quer= "INSERT INTO systemtracer2 values('','".date("20y-m-d")."',' STUDENTS WERE REGISTERED TO COURSE BY THE DEAN OF FACULTY OF ".$ngonyan['faculty']."  WITH THE NAME ".$ngonyan['name']." AND ".$_SESSION['USERREG']." REGSRATION NUMBER IN ".date("20y-m-d")." at ".time("h:m:s")."')";
$resul=mysql_query($quer);
mysql_error;
...
$idno=$arr_new1[1];
$coursecode=$arr_new1[2];
$regdate=$arr_new1[3];
$y_study=$arr_new1[4];


$aaa="select * from student where student.id_no='$idno' and student.faculty='".$ngonyan['faculty']."'";
$aa=mysql_query($aaa);
$aaaa=mysql_num_rows($aa);

if ($aaaa==1){
$sql = "insert into course_regsration set
id_no='$idno',
...
$_POST='';
 ...
 echo "<script language='javascript'>
                alert('$msg;');
				window.location='addstudenttocourse.php';
                </script>";
}
...
<table width="63%"  border="1" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td width="18%"><div align="center">course-Id</div></td>
    <td width="20%"><div align="center">reg-date</div></td>
    <td width="18%"><div align="center">YEAR OF STUDY</div></td>

  </tr>
  <tr>
    <td><div align="center">1</div></td>
    <td><div align="center">bsc/t/13</div></td>
    <td><div align="center">RMT102</div></td>
    <td><div align="center">2012-08-16</div></td>
    <td>2011/2012</td>
