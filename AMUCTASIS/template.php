...
$page_name="addresult.php"; //  If you use this code with a different page ( or file ) name then change this 
$start=$_GET['start'];
...
// $result4=mysql_query($query4);
 ...
 //echo"</br>";echo"".$mero['name']."";echo"WITH REGSRATION No $dent_reg";
  echo"</center>";
$COUNT=0;
echo"<form name=form0 method='post' action='' >";
?>
...
<form id='form1' name='form1' method='post'  action='addresult2.php'>
 ...
 echo" <option value='$course_code'>"; echo"<b>"; echo"$course_code"; echo"</b>"; echo"</option>";
    ...
    echo" </td>";
     ...
     echo"<input type='text' name=''  value='".strtoupper("".$laswai['score']."")."' size='5' disabled='disabled'/>";
	 echo" </td>";
	  echo" <td>"; ?>
	  ...
	  echo"<td>";
	   ?>
     <input name="checkbox[]" type="checkbox" id="checkbox[]"  class="case"  value="<?php echo $laswai['course_code']+$laswai['id_no'];?>" />
     <?php
	  echo"</td>";
      echo" </tr>";
...
echo"<td colspan='6'align='center'bgcolor='#FFFFFF'><input name='delete' type='submit' value='Delete'></td>
</tr>";	  
...
$query4="select* FROM perfomance ";
	$result4=mysql_query($query4);
	while($ds=mysql_fetch_array($result4)){
	
	if(("".$ds['course_code'].""+"".$ds['id_no']."")==$del_id)
	
$query3="DELETE FROM performance WHERE (perfomance.course_code='".$ds['course_code']."')and perfomance.id_no=".$ds['id_no']."";
