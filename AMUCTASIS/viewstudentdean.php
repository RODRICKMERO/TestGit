...
echo "<tr bgcolor='#ffdfaa'><td>$hh</td><td>".$laswai['id_no']."</td><td>".ucwords("".$laswai['name']."")."</td><td> ".$laswai['faculty']."</td><td><a href='viewresultdean.php?N=".$laswai['id_no']."'>RESULT </a></td></tr> " ;
			  $a="2"; 			  
			 }
           else
              {
			...
			echo "<tr bgcolor='#EEEEEE'><td>$hh</td><td>".$laswai['id_no']."</td><td> ".ucwords("".$laswai['name']."")."</td><td> ".$laswai['faculty']."</td><td><a href='viewresultdean.php?N=".$laswai['id_no']."'>RESULT </a></td></tr> " ;
			  $a="2"; 			  	
				 $a="1";
