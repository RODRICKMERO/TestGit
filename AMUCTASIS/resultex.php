...
var resultex.php = new Spry.Widget.ValidationTextField("resultex.php", "none", {validateOn:["change"]});
//-->
       </script>
     </p>
...
$page_name="resultex.php"; //  If you use this code with a different page ( or file ) name then change this 
$start=$_GET['start'];
