     ...
     <table width="408" border="0" cellspacing="0" cellpadding="0">
       <tr>
         <td width="425" height="29"><strong>
           <marquee>
             <span class="style35">VIEW Result</span>
             </marquee>
         </strong></td>
       </tr>
     </table>
...
echo"<br><br>";
$x1="select*from faculty where faculty.f_name='".$mero['faculty']."'";
$x2=mysql_query($x1);
$x3=mysql_fetch_array($x2);

echo"<table cellpadding='0' cellspacing='0' border='0' align='centre' width='600'>
<tr><td><center>PROVISIONAL ACADEMIC REPORT</center></td></tr>
<tr><td><center>".date("d/m/20y")."</center><br><br></td></tr>


<tr><td>Programme: ".ucfirst("".$x3['f_description']."")."</td></tr>
...
$page_name="progressive.php"; //  If you use this code with a different page ( or file ) name then change this 
$start=$_GET['start'];
...
echo "<tr bgcolor='#6699CC'><th align='left'><font style='Times New Roman'case='UPPERCASE' style='font-size:12px'>CODE:</th><th align='left'><font style='Times New Roman' style='font-size:12px'>SUBJECT NAME:</th><th align='left'><font style='Times New Roman'case='UPPERCASE' style='font-size:12px'>MARKS:</th><th align='left'><font style='Times New Roman'case='UPPERCASE' style='font-size:12px'>GRADE:</th>
</tr>";
...
while( $martha=mysql_fetch_array($result2) )
  {        
		     if($a==1)
			 {
if(("".$martha['course_code'].""!="LG 211")and("".$martha['course_code'].""!="LG 221"))

{ 			   
echo "<tr bgcolor='#ffdfaa'>";echo"<td>";echo"".$martha['course_code']."";echo"</td>";echo"<td>";echo"".$martha['course_name']."";echo"</td>";echo"<td>"; 
echo"".round ($martha['marks'],0)."";echo"</td>";echo"<td>";echo"".$martha['score']."";echo"</td>";echo"</tr> " ;
...
echo "<tr bgcolor='#ffdfaa'>";echo"<td>";echo"".$martha['course_code']."";echo"</td>";echo"<td>";echo"".$martha['course_name']."";echo"</td>";echo"<td>"; 
echo"$pass";echo"</td>";echo"<td>";echo"$pass";echo"</td>";echo"</tr> " ;
...
{
if( "".$martha['marks']."">=50){$pass="Pass";}else{$pass="Fail";}
echo "<tr bgcolor='#EEEEEE'>";echo"<td>";echo"".$martha['course_code']."";echo"</td>";echo"<td>";echo"".$martha['course_name']."";echo"</td>";echo"<td>"; 
echo"$pass";echo"</td>";echo"<td>";echo"$pass";echo"</td>";echo"</tr> " ;
...
echo"<center><p><font style='Times New Roman'font-size:12px color='blue' >";
echo"            Total unit $TOTALUNIT     Total scored points $TOTALPOINT GPA is ".round($GPA,2);


echo"<table cellpadding='0' cellspacing='0' border='0' align='centre' width='600' style='font-size:12px'>
<tr><td><center>__________________________<br>Deputy Principal (Academic)</center></td></tr>
<tr><td>Rating: 	100-80% = A (Distinction), 79-70% = B+ (High Credit), 69-60 = B (Credit), 59-50 = C (Pass), 49-35 = D (Fail),<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 34-00 = E (Bad Fail)</td></tr>
</table>";
