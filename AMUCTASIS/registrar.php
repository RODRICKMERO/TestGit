...
//-->
     ...
     <table width="408" border="0" cellspacing="0" cellpadding="0">
       <tr>
         <td width="425" height="29"><strong>
           <marquee>
             <span class="style35"> REGISTER STUDENT </span>
             </marquee>
         </strong></td>
       </tr>
     </table>
     ...
     <br />
     <div align="center">
       <form action="student.php" method="post" name="registration" id="registration">
         <table width="563">
           <tr>
             <td width="236" height="35" align="center" valign="top"><strong>student name: </strong></td>
             <td width="291" height="35" align="right" valign="top"><div align="left"> <span id="sprytextfield1">
               <label>
                 <input type="text" name="dent_name" size="20" id="dent_name" />
                 </label>
           ...
           <tr>
			 ...
			 if ($n==0){
			  ...
			  echo "<script language='javascript'>
                      alert('NO REGISTERED FACULTY PLEASE CONTACT DPAA!');
                       </script>";
	  echo "<script language='javascript'>" ; 
		echo " window.location=('registrarmain.php')";
           ...
           <tr>
             <td width="236" height="30" valign="top" align="center"><strong>loging password: </strong></td>
             <td width="291" height="30" valign="top" align="right"><div align="left"> <span id="sprytextfield3">
               <label>
                 <input type="text" name="dent_password" size="20" id="dent_password" />
                 </label>
               <span class="textfieldRequiredMsg">Avalue is required.</span></span> </div></td>
  </tr>
           <tr>
