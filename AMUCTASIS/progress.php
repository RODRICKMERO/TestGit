     ...
     <table width="408" border="0" cellspacing="0" cellpadding="0">
       <tr>
         <td width="425" height="29"><strong>
           <marquee>
             <span class="style35"> PROGRESS RESULT PAGE </span>
             </marquee>
         </strong></td>
       </tr>
     </table>
...
<tr><td> REGISTRATION NUMBER  : ".$_SESSION['USERREG']."</td></tr>
</table>";
...
$page_name="progress.php"; //  If you use this code with a different page ( or file ) name then change this 
$start=$_GET['start'];
